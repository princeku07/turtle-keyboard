...
public final class SplitContract {
    ...
    /** SharedPreferences file name shared between the keyboard's settings layer and the
     *  Split UI. Both sides must point at the same file or saves won't be visible across. */
    public static final String STORAGE_FILE = "turtle_prefs";
